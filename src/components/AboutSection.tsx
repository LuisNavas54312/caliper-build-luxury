  ...
  return (
    <section className="py-24 md:py-32 px-6 md:px-12 bg-background" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          <span className="text-foreground font-normal">Caliper Build Partners LLC</span> is a tech-enabled General Contracting
          firm specializing in high-margin luxury residential builds and commercial structural concrete
          in Miami. Founded by <span className="text-foreground font-normal">Luis Navas</span>, we leverage extensive field experience at
